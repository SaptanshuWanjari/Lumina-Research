    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Ingest a URL, upload a file, or paste raw text into the local
            research desk.
          </DialogDescription>
        </DialogHeader>
          ...
          <TabsContent value="n8n" className="space-y-3 pt-4">
            ...
            <div className="rounded-lg bg-blue-50 p-3 text-xs text-blue-800">
              ...
              <ul className="list-inside list-disc space-y-1">
                <li>
                  Use a <strong>Webhook Trigger</strong> (supports POST
                  requests).
                </li>

                <li>
                  Respond <strong>synchronously</strong> with a
                  {" "}
                  "Respond to Webhook" node.
                </li>

                <li>
                  Return valid <strong>JSON</strong> containing a
                  {" "}
                  <code>text</code>, <code>content</code>, or
                  {" "}
                  <code>markdown</code> field.
                </li>

                <li>
                  <strong>Tip:</strong> Use a Function node to
                  validate/clean JSON before responding.
                </li>
              </ul>
            </div>
          </TabsContent>
